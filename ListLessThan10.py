...
# 1. Instead of printing the elements one by one, make a new list that has all the elements less than
...
lessThan5List = [i for i in a if i < 5]
print(lessThan5List)

num = int(input("Enter a number: "))
lessThanNum = [i for i in a if i < num]
print(lessThanNum)
